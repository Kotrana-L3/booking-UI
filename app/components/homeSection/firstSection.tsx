...
export default function FirstSection() {
    return (
        <div>
            <section className='firstSection text-center'>
                <h1 className='uppercase font-light text-5xl '>
                    ACHETEZ NOS FAVORIS
                </h1>
                <div className='flex flex-row gap-16  justify-center mt-32 ml-52'>
                    <div className='flex flex-col gap-12 pt-3'>
                        <div className='flex flex-col items-center justify-center pr-5'>
                            <h1 className='uppercase font-light text-black text-4xl fi gifUnderTitle'>
                                BOUGIES PARFUMÉES
                            </h1>
                            <h1 className='uppercase font-light text-black text-4xl fi gifUnderTitle pr-2'>
                                ESSENCE DE NATURE
                            </h1>
                        </div>
